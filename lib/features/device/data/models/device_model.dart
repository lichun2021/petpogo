import 'device_product_model.dart';
...
class DeviceModel {
  ...
  /// 产品目录通过 productKey 精确匹配后回填 alias，业务页只读这里。
  DeviceProductType get productType {
    final aliasType = DeviceProductType.fromAlias(productAlias);
    return aliasType == DeviceProductType.unknown
        ? DeviceProductType.fromProductKey(productKey)
        : aliasType;
  }

  bool get isCollar => productType == DeviceProductType.collar;
  bool get isRobot => productType == DeviceProductType.robot;

  String get productDisplayName => productTypeName.trim().isNotEmpty
  ...
  factory DeviceModel.fromJson(Map<String, dynamic> json) => DeviceModel(
        ...
        productAlias: (json['productAlias'] as String?) ?? '',
  ...
  DeviceModel copyWith({
    ...
    int? updateTime,
      ...
      DeviceModel(
        ...
        productAlias: productAlias ?? this.productAlias,
  ...
  @override
  String toString() =>
      'DeviceModel(id=$deviceId, name=$displayName, online=$connect, role=$roleLabel)';
}
