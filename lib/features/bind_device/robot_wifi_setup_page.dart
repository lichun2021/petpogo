...
class RobotWifiSetupPage extends ConsumerStatefulWidget {
  ...
  const RobotWifiSetupPage({
    super.key,
    this.productKey = DeviceProductKeys.robot,
  });
...
class _RobotWifiSetupPageState extends ConsumerState<RobotWifiSetupPage>
                ...
                if (i.isOdd) {
                  ...
                  return Expanded(
                    child: Container(
                      height: 2,
                      color:
                          done ? AppColors.primary : AppColors.outlineVariant,
                    ),
                  );
                }
                final idx = i ~/ 2;
  ...
  Widget _buildBody() {
    switch (_step) {
      case _SetupStep.wifi:
        return _buildWifiForm();
      case _SetupStep.qrcode:
        return _buildQrCode();
      case _SetupStep.waiting:
            ...
            child: Container(
              ...
              child: Stack(alignment: Alignment.center, children: [
                Icon(Icons.wifi_rounded,
                    size: 52, color: AppColors.primary.withValues(alpha: 0.25)),
